...
class mail_bank_Zend_Mail extends mail_bank_Zend_Mime_Message {
    ...
    * advanced settings)
    */
   public function createAttachment($body, $mimeType = mail_bank_Zend_Mime::TYPE_OCTETSTREAM, $disposition = mail_bank_Zend_Mime::DISPOSITION_ATTACHMENT, $encoding = mail_bank_Zend_Mime::ENCODING_BASE64, $filename = null) {
