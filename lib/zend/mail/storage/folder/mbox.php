...
/**
 * @see mail_bank_Zend_Mail_Storage_Mbox
 */
if (file_exists(MAIL_BANK_DIR_PATH . 'lib/zend/mail/storage/mbox.php'))
   require_once MAIL_BANK_DIR_PATH . 'lib/zend/mail/storage/mbox.php';
 ...
 * @license  http://framework.zend.com/license/new-bsd  New BSD License
 */
class mail_bank_Zend_Mail_Storage_Folder_Mbox extends mail_bank_Zend_Mail_Storage_Mbox implements mail_bank_Zend_Mail_Storage_Folder_Interface {
    ...
    * 	- filename use mail_bank_Zend_Mail_Storage_Mbox for a single file
    ...
    * @param mail_bank_Zend_Mail_Storage_Folder|null $parentFolder used for recursion
